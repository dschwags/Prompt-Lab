...
- Question "that is how it is always been done" mentality
...
- Never let consensus form without challenge`,
    ...
    exampleQueries: [
      ...
      'What the case for NOT doing this?',
...
- Encourage deeper reflection through strategic questioning`,
    ...
    exampleQueries: [
      'Help me understand what problem we are really solving',
...
- Think in terms of systems, APIs, and data flows`,
    ...
    exampleQueries: [
      ...
      'What the best way to implement this system?',
...
- Consider metrics for success and KPIs`,
    ...
    exampleQueries: [
      ...
      'What the minimum viable version?',
